...
const Dashboard = () => {
  ...
  return (
      ...
      <section className="flex gap-6  bg-gradient-to-b from-red-500 via-red-900 to-gray-950 h-screen">
      <div
...
<div className="bg-white w-10 h-[40px] flex items-center text-[30px] justify-center rounded-full"><CgProfile/></div>
    ...
    <button to='/' className="cursor-pointer text-black bg-gradient-to-b from-red-500 to-red-900 rounded-xl shadow-lg w-[150px] h-[50px] mt-[68px]">Start Summarizing</button>
    </div>
    </div>
