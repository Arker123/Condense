import math
import itertools
from typing import Dict, List, Tuple, Union, TypeVar, Callable, Iterator, Optional, Sequence, cast
...
from black.brackets import DOT_PRIORITY, COMMA_PRIORITY, BracketTracker
