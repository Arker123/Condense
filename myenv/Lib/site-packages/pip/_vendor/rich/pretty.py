...
from collections import Counter, UserDict, UserList, deque, defaultdict
...
if TYPE_CHECKING:
    from .console import Console, RenderResult, JustifyMethod, ConsoleOptions, OverflowMethod, HighlighterType
