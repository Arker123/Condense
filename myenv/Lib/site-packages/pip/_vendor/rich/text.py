...
from typing import TYPE_CHECKING, Any, Dict, List, Tuple, Union, Callable, Iterable, Optional, NamedTuple
...
if TYPE_CHECKING:  # pragma: no cover
    from .console import Console, JustifyMethod, ConsoleOptions, OverflowMethod
